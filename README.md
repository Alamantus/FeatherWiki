...
A 55.501 kilobyte [quine](https://en.wikipedia.org/wiki/Quine_(computing)) for simple, self-contained wikis! The idea is that it's like
...
Warbler is the server build of Feather Wiki, and it is exactly the same as Wren except that it is larger (56.495 kilobytes) because it includes extra code for saving to certain web servers.
