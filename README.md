...
A 54.437 kilobyte [quine](https://en.wikipedia.org/wiki/Quine_(computing)) for simple, self-contained wikis! The idea is that it's like
...
Warbler is the server build of Feather Wiki, and it is exactly the same as Wren except that it is larger (55.424 kilobytes) because it includes extra code for saving to certain web servers.
