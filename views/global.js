...
export const globalView = (state, emit) => {
  ...
  return html`<body>
    ...
    <footer>
      <span class=fr>{{translate:poweredBy}} <a href="{{package.json:homepage}}" title="{{translate:version}}: {{package.json:version}} ({{package.json:nickname}})" target="_blank">{{package.json:title}}</a></span>
    </footer>
    <div class=notis>
      ${Object.values(notis)}
    </div>
