...
export const globalView = (state, emit) => {
  ...
  return html`<body>
    ...
    <footer>
      <span class="fr">Powered by <a href="{{package.json:homepage}}" title="Version: {{package.json:version}}{{buildVersion}}" target="_blank" rel="noopener noreferrer">{{package.json:title}}</a></span>
    </footer>
    <div class=notis>
